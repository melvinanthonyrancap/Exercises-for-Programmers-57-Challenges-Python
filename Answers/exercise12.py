...
intrest_rate = float(input("Enter the rate of interest:"))
years = int(input("Enter the number of eyars:"))

total_investment = principal * (1 + ((intrest_rate / 100) * years))

print(f"After {years} years at {intrest_rate}%, the investment will be worth ${total_investment:.0f}.")
